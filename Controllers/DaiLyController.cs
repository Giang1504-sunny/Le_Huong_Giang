...
namespace DeMoMVC.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaDaiLy,TenDaiLy,DiaChi")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaDaiLy,TenDaiLy,DiaChi")] DaiLy daiLy)
        {
            if (id != daiLy.MaDaiLy)
            {
                return NotFound();
